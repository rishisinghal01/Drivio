      ...
      >
        ...
        <div className='mt-8 space-y-6'>
         ...
         <div>
          ...
          <input onChange={(e)=>setvehicleNumber(e.target.value.toUpperCase())} value={vehicleNumber} type="text" placeholder='MH12AB1234' id='vn' className='mt-2 w-full border-b border-gray-300 pb-2 text-sm focus:outline-none focus:border-black transition' />
         </div>
          ...
          <input onChange={(e)=>setvehicleModel(e.target.value)} value={vehicleModel} type="text" placeholder='TATA Ace' id='vm' className='mt-2 w-full border-b border-gray-300 pb-2 text-sm focus:outline-none focus:border-black transition' />
         </div>
