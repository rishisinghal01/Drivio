      ...
      <div className='max-w-7xl mx-auto'>
        ...
        >
          ...
          <div className='hidden sm:flex items-center gap-2'>
            ...
            <motion.div onClick={()=>scroll("left")}
              whileTap={{ scale: 0.88 }}
...
onClick={()=>scroll("right")}
        ...
        <div className='relative'>
          ...
          <div className='flex gap-5 pt-20 overflow-x-auto scroll-smooth pb-4 px-1' ref={sliderref} style={{ scrollbarWidth: "none", msOverflowStyle: "none" }}>
            {VEHICLE_CATEGORIES.map((cat, i) => {
              ...
              return (
                ...
                >
                  ...
                  <motion.div
                    animate={{
                      backgroundColor: isHovered ? "#0909b" : "#ffff",
                      borderColor: isHovered ? "#0909b" : "#e4e4e7",
                      boxShadow: isHovered ?
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <cat.Icon size={24} strokeWidth={1.4} />
        ...
        >
         {
          [
            ...
            {num:"24/7",lable:"Availablity"}
          ].map((obj,i)=>(
            <div key={i} className='flex items-center gap-3'>
              <p className='text-zinc-900 text-lg font-black tracking-tight'>{obj.num}</p>
              <p className='text-zinc-400 text-xs font-medium'>{obj.label}</p>
